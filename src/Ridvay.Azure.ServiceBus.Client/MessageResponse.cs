...
namespace Ridvay.Azure.ServiceBus.Client
{
...

    {
        ...
        {
            return _processMessageEventArgs.AbandonMessageAsync(_processMessageEventArgs.Message, propertiesToModify, cancellationToken);
        }
        ...
        {
            return _processMessageEventArgs.CompleteMessageAsync(_processMessageEventArgs.Message, cancellationToken);
        }
        ...
        public Task DeadLetterMessageAsync(string deadLetterReason,
            ...
            CancellationToken cancellationToken = default)
        {
            return _processMessageEventArgs.DeadLetterMessageAsync(_processMessageEventArgs.Message, deadLetterReason, deadLetterErrorDescription, cancellationToken);
        }
        ...
        public Task DeadLetterMessageAsync(IDictionary<string, object> propertiesToModify = default,
            CancellationToken cancellationToken = default)
        {
            return _processMessageEventArgs.DeadLetterMessageAsync(_processMessageEventArgs.Message, propertiesToModify, cancellationToken);
        }
        ...
        public Task DeferMessageAsync(IDictionary<string, object> propertiesToModify = default,
            CancellationToken cancellationToken = default)
        {
            return _processMessageEventArgs.DeferMessageAsync(_processMessageEventArgs.Message, propertiesToModify, cancellationToken);
        }
        ...
        {
            return _processMessageEventArgs.RenewMessageLockAsync(_processMessageEventArgs.Message, cancellationToken);
        }
