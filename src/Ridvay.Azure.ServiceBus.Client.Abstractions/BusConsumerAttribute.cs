...
namespace Ridvay.Azure.ServiceBus.Client.Abstractions
{
    ...
    public class BusConsumerAttribute : Attribute
    {
        ...
        /// </remarks>
        /// <value>
        ///     <c>true</c> to complete the message automatically on successful execution of the message handler; otherwise, <c>false</c>.
        ...
        /// </summary>
        /// <value>
        ///     The subqueue to connect the processor to. The default value is <see cref="SubQueue.None" />, meaning the processor will
