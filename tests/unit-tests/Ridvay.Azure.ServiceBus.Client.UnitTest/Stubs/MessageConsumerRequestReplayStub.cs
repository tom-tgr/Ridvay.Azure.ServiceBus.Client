...
namespace Ridvay.Azure.ServiceBus.Client.UnitTest.Stubs
{
    ...
    {
        public Task<MessageDummyType> OnMessageAsync(IMessageResponse<MessageDummyType> message)
        {
        ...
        IMessageConsumer<MessageDummyType2, MessageDummyType2>
    {
        ...
        public Task<MessageDummyType2> OnMessageAsync(IMessageResponse<MessageDummyType2> message)
        {
    ...
    {
        public Task OnMessageAsync(IMessageResponse<MessageDummyType> message)
        {
            var a = message;
